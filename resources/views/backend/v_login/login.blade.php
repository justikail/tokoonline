...
<head>
    ...
    <meta name="description" content="Projek Toko Online Web Programming 2">
    <meta name="author" content="Elsa Marisa Gultom">
    <!-- Favicon icon -->
            ...
            <div class="auth-box bg-dark border-top border-secondary">
                <div id="loginform">
                    <div class="text-center p-t-20 p-b-20">
                        <span class="db"><img src="{{asset('backend/image/logo_text.png') }}" 
                         /></span>
                    </div>
                    <!-- Form -->
                    <!-- eror -->
                        ...
                        <div class="row p-b-30">
                            <div class="col-12">
                                <div class="input-group mb-3">
                                    ...
                                    @error('email')
                                    <span class="invalid-feedback alert-danger">Email salah.</span>
                                    @enderror
                                </div>
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                    ...
                                    @error('password')
                                    <span class="invalid-feedback alert-danger">Password salah.</span>
                                    @enderror
                                </div>
                            </div>
                        </div>
